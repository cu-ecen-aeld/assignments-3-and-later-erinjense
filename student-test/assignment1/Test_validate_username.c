...
void test_validate_my_username()
{
    ...
    char * mem_username = malloc_username_from_conf_file();
    char const * const username = my_username();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(mem_username, username, "strings not equal");
    free(mem_username);
}
